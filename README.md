...
Date of Access: 11-19-2024. [Link to data](https://meds-eds-220.github.io/MEDS-eds-220-course/book/chapters/lesson-15-rioxarray/lesson-15-rioxarray.html)
...
Date of access: 11-19-2024. [Link to data](https://catalog.data.gov/dataset/california-fire-perimeters-all-b3436)

Citation: “Data.gov,” Data.gov, 2024. https://catalog.data.gov/dataset/california-fire-perimeters-all-b3436 (accessed Nov. 19, 2024).


**Landsat Data.**
Date of access: 11-19-2024. [Link to data](https://planetarycomputer.microsoft.com/dataset/landsat-c2-l2)
...
Date of Access: 10-29-2024 [Link to data](https://www.airnow.gov/aqi/aqi-basics/)
...
Date of Access: 12-04-2024 [Link to website](https://sbbucketbrigade.org/timeline/2017-thomas-fire/)
